...
public class Kasir {
    ...
    public void tambahPelanggan(int nomorMeja, Pelanggan pelanggan) {
        ...
        System.out.print ("Mohon masukkan nomor meja : ");
        int nomorMeja = scanner.nextInt();
        scanner.nextLine();
        System.out.print("Nama Kamu : ");
        String namaMeja = scanner.nextLine();
        Pelanggan pelanggan = new Pelanggan(namaMeja);
        tambahPelanggan(nomorMeja,pelangganB);
    }
